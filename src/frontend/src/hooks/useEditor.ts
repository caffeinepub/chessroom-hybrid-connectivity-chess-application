...
function clearBadges(): void {
  ...
  // biome-ignore lint/complexity/noForEach: NodeList forEach is appropriate here
...
export class EditCommunicator {
  ...
  #clearAllSelections(): void {
    ...
    // biome-ignore lint/complexity/noForEach: NodeList forEach
  ...
  #generateDOMTreeString(element: HTMLElement): string {
    ...
    const buildTree = (
      ...
      // biome-ignore lint/complexity/noForEach: array forEach
